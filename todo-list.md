...
| P12 | Structural Rate Database (configurable, not hard-coded) | 4/5/4/2 | `building` (`v1.30.0` engine: entries, lookup by code/location/date, store, sheet builder; the sheet in the workbook, the dialog tab and the Detailed BOQ rates follow) |
